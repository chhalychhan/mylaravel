        ...
        <div class="navbar-nav ms-auto py-0">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu m-0">
                    ...
                    <a href="{{route('front.team')}}" class="dropdown-item {{(request()->is('team'))? 'active':''}}">Travel Guides</a>
                    <a href="{{route('front.testimonial')}}" class="dropdown-item{{(request()->is('testimonial'))? 'active':''}}">Testimonial</a>
                    <a href="{{route('front.err')}}" class="dropdown-item {{(request()->is('err'))? 'active':''}}">404 Page</a>
                </div>
            </div>
